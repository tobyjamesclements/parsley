...
/** The wire format is strict and canonical: every deviation is undecodable, and undecodable never means "no causes". */
class CausesCodecTest {
    ...
    void matchesTheFrozenGoldenBytes() throws Exception {
        // Golden vector, hand-assembled from docs/METADATA.md alone. If this test and the implementation ever
        // disagree, the *document* wins: the representation is frozen (SPEC Structural 5).
        ...
        // Unsigned lexicographic order of the 20-byte encodings: 0x01... sorts before 0xF1...
    ...
    void channelOrderIsTheUnsignedOrderOfTheEncoding() {
        ...
        // Signed UUID.compareTo would sort the high-bit UUID first; the wire format's rule is unsigned byte order.
