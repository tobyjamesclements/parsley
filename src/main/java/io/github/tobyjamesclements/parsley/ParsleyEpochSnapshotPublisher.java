 ...
 * member id and the node's current {@link ParsleyCausalBroadcast#completeness() completeness} frontier; every
 ...
 * causal-broadcast core. The default {@link #NOOP} disables publication (coordination not configured), so a node
