 ...
 *       outputs correctly gated everywhere from the first emission. Parsley has no configuration
 *       keys at all; startup fails if any {@code parsley.*} key is present.</li>
