...
/**
 * The {@link CausalTopics} implementation. Two modes, chosen by constructor: wrapping a single
 ...
 */
final class ParsleyTopics implements CausalTopics {
    ...
    ParsleyTopics(ParsleyTopicAdmin admin) {
        this.admin = Objects.requireNonNull(admin, "admin must not be null");
        this.props = null;
    }

    ParsleyTopics(Properties props) {
        this.admin = null;
