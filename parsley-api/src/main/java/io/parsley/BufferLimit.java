 ...
 *   <li>{@link #ofFrontierAdvancement(long)} — evict after the frontier has advanced this many
 *       times <em>(not yet implemented; throws at construction time)</em>
...
public sealed interface BufferLimit permits
        ...
        BufferLimit.BytesLimit,
        BufferLimit.FrontierAdvancementLimit,
     ...
     * <p><strong>Not yet implemented.</strong>
     *
     * @param advancements the frontier advancement threshold
     * @return a new {@code FrontierAdvancementLimit}
     */
    static BufferLimit ofFrontierAdvancement(long advancements) {
        return new FrontierAdvancementLimit(advancements);
    }
    ...
    /**
     * Evicts records once the frontier has advanced at least {@code advancements} times since
     * the record was buffered.
     *
     * <p><strong>Not yet implemented.</strong> Constructing a {@link BufferingPolicy} with this
     * limit throws {@link UnsupportedOperationException}.
     *
     * @param advancements the minimum number of frontier advancements required before eviction
     */
    record FrontierAdvancementLimit(long advancements) implements BufferLimit { }
