 ...
 *
 * <p>Provides {@link io.parsley.crypto.jdk.aes.JdkFenceTokenEncryption}, which is registered
 ...
 */
module io.parsley.crypto.jdk.aes {
    requires io.parsley;
    exports io.parsley.crypto.jdk.aes;
    provides io.parsley.FenceTokenEncryption
            with io.parsley.crypto.jdk.aes.JdkFenceTokenEncryption;
}
